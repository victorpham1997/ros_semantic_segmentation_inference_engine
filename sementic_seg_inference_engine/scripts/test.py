...
cv2.imwrite('output/output_sample.png', cv2.resize(output, (image_width, image_width)))
cv2.imwrite('output/input_sample.png', cv2.resize(cv2.imread(opt.test_image, 1), (image_width, image_width)))
